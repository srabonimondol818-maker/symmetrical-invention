...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # ③ 🎙️ Send welcome voice MIDDLE + Join/Help buttons attached
        ...
        if welcome_voice_enabled:
            ...
            if voice_file_id:
                try:
                    # Voice এর সাথেই Join+Help button জুড়ে দিই — extra message নাই
        ...
        elif bottom_keyboard and not custom_buttons:
            # Voice না থাকলে আলাদা message এ buttons দাও
